...
# In this case, input_size = 27 (9 eyes * 3 info), output_size = 4 (4 kinds of movements). 
class QNetwork(nn.Module): 
    ...
    def forward(self, x): 
        # Ensure x is a 1D tensor of size 27. 
        x = x.flatten()  # Flatten the input to a 1D tensor. 
